...
const Home = () => {
    return (
        <div>
            <h1 className='text-8xl font-thin text-center mt-10 tracking-normal hover:text-primary'>MAHFUZ SWARON</h1>
            ...
            <p className='text-left mx-auto w-1/3 text-xl whitespace-pre-line pb-10 font-sans'>
                {
